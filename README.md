...
Dette prosjektet dokumenterer praktiske laboratorieøvelser innen Linux-systemanalyse, nettverksovervåkning og ytelsestesting både på VM og i Docker-container. Øvelsene ble gjennomført i et virtualisert Ubuntu-miljø med VirtualBox.
...
| `docker-vs-vm.md` | Sammenlignende lasttest – Nginx i Docker vs. VM |
