...
### Last ned og start Nginx-container
...
Samme kommando ble brukt i begge tester:
...
Testen har noen svakheter det er viktig å være åpen om:

1. **Ulike Nginx-versjoner** — VM kjørte 1.27.3, Docker kjørte 1.18.0. Dette gjør det ikke til en helt ren sammenligning, da versjonsforskjeller kan påvirke ytelse og konfigurasjon.
2. **Samme maskin** — begge tester kjørte på samme VM, og Docker-testen kjørte på et system som allerede hadde andre prosesser i gang.
